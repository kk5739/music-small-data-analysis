...
with sqlite3.connect(db_file) as conn:
    ...
    # Dropping Indexes to compare original with indexed query performance
    cursor.execute("DROP INDEX IF EXISTS idx_track_artist_album;")
    cursor.execute("DROP INDEX IF EXISTS idx_album_listens;")
    cursor.execute("DROP INDEX IF EXISTS idx_album_id;")
    cursor.execute("DROP INDEX IF EXISTS idx_artist_id;")
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_track_artist_album ON track(artist_id, album_id);")
